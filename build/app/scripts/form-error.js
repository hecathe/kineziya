var formInputs = document.querySelectorAll('.contacts__input');
var forms = document.querySelectorAll('.contacts__form');
var popupForm = document.querySelector('.popup-form-wrap');
var popupApp = document.querySelector('.popup-app-wrap');
